...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: "associateAnalytics",
        component: AssociateAnalyticsComponent,
        pathMatch: "full",
      },
      ...
      {
        path: "agileCampaign",
        component: AgileCampaignComponent,
        pathMatch: "full",
      },

      {
        path: "accessTokenReports",
        component: AccessTokenReportsComponent,
        pathMatch: "full",
      },
      ...
      {
        path: "revenueMonitoring",
        component: RevenueMonitoringComponent,
        pathMatch: "full",
      },

      {
        path: "forYourAction",
        component: ForYourActionComponent,
        pathMatch: "full",
      },
      ...
      {
        path: "smartReports",
        component: SmartReportsComponent,
        pathMatch: "full",
      },
    ],
  },
